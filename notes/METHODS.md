...
The long-form sections of this project, moved out of the README so the README
stays a front door. Nothing here has been rewritten: these are the original
sections with their headings, tables and numbers unchanged. Figures live in the
README next to the summary of each section. The decision trail, including the
wrong turns, is in [NOTES.md](../NOTES.md).
